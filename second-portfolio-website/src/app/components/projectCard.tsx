...
const ProjectCardComponent = ({Project}:{Project:ProjectCards}) => {
  return (
    <div className="md:mx-8 transformScale relative bg-gradient-to-b from-[#0a6335] to-gray-500 shadow-[0_4px_10px_rgba(0,0,0,0.5)] rounded-xl p-2 flex flex-col justify-center items-center w-full md:max-w-60 mb-4 md:mr-4 h-72">
