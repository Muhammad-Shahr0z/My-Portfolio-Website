...
const Card = ({Card}:{Card:Cards})  => {
  ...
  return (
    <div className="bg-white bg-gradient-to-b from-[#0a6335] to-gray-500 shadow-[0_4px_10px_rgba(0,0,0,0.5)] rounded-xl p-2 flex flex-col items-center w-full md:max-w-60 hover:animate-pulse  mb-4 md:mr-4 h-72">

      <div className='h-36 flex justify-center items-center'>
      <Image src={Card.src} alt="HTML" width={80} height={80} className='hover:animate-bounce'/>
      </div>
