...
const cardImages = [
  ...
  { src: "/reactjs.png",h3:"ReactJS",percentage:"55%",detail:" React:A JavaScript library for building user interfaces with reusable components"},
  { src: "/nextjs.png",h3:"NextJS",percentage:"50%",detail:"Next.js:A React framework for building optimized, server-side rendered web applications."},
  { src: "/figma.png",h3:"Figma",percentage:"45%",detail:"Figma is a cloud-based design tool that enables UI/UX designers to collaborate on design and prototyping"},
  { src: "/nodejs.png",h3:"Node JS",percentage:"50%",detail:"Node.js is a server-side JavaScript runtime that enables building scalable web applications"},
